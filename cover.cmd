...
tools\dotCover\dotCover.exe report /Source="test\coverage.snapshot" /Output="coverage\coverage.html" /ReportType="HTML"

tools\ReportGenerator\ReportGenerator.exe "-reports:test\coverage.xml" "-targetdir:coverage" "-reporttypes:Badges"